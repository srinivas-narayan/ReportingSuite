...
namespace SriReportSuite.Models
{
    ...
    public class Study
    {
        ...
        public int Consultant_ConsultantID { get; set; } //ID of consultant referring patient - foreign key to class Consultant
        ...
        public int MRIConsultant_ConsultantID { get; set; } //ID of consultant supervising study - foreign key to class MRIConsultant (superclass of Consultants)
